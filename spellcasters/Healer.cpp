...
Healer::Healer(const char* title, int hitPoints, int damage, int resistCoeff, bool isUndead, int mana)
    : SpellCaster(title, hitPoints, damage, resistCoeff, isUndead, mana), Observable(this) {
        this->magicAbility = new MagicAttack(this, new Heal());
...
void Healer::transition(int marker) {
